(()=>{
    ...
    (()=>{
        ...
        "object" == typeof browser && "object" == typeof browser.runtime && (t = browser),
        e = t.storage.local,
        ...
        function a(e) {
            Object.keys(e).forEach((t=>{
                if ("boolean" == typeof e[t]) {
                    ...
                    n && (n.checked = e[t]),
                    "yt_on" === t && s.setAttribute(t, e[t])
                } else
                    Object.keys(e[t]).forEach((n=>{
                        const o = document.getElementById(n);
                        if (o && (o.checked = e[t][n]),
                        "dark_mode" === n || "yt_on" === n)
        ...
        function m(e, t) {
            ...
            !1 === t ? (o.indeterminate = !1,
            o.checked = !1,
            c(n)) : o.indeterminate = !0;
        ...
        function h(e) {
            ...
            Object.prototype.hasOwnProperty.call(t, "hide_feed") ? d(t.hide_feed, e.hide_subs) : Object.prototype.hasOwnProperty.call(t, "hide_subs") && d(e.hide_feed, t.hide_subs),
            o(t)
        }
        function u() {
            const e = this.checked
            ...
            if (t.classList.contains("check-tree")) {
                ...
                "UL" === t.tagName && "LI" === t.parentNode.tagName && m(t.parentNode, e);
            n(h)
        }
        const g = document.getElementsByClassName("check");
        for (let e = 0; e < g.length; e += 1)
            g[e].addEventListener("change", u);
        function f(e) {
            s.setAttribute("yt_on", e),
            o({
                yt_on: e
            })
        }
